...
// Scroll to section 1
document.querySelector('#link-1').addEventListener('click', (e) => {
    scrollIt(
...
// Scroll to section 2
document.querySelector('#link-2').addEventListener('click', (e) => {
    scrollIt(
...
// Scroll to section 3
document.querySelector('#link-3').addEventListener('click', (e) => {
    scrollIt(
...
// Scroll to section 4
document.querySelector('#link-4').addEventListener('click', (e) => {
    scrollIt(
